...
| eBPF X-Ray | [../scripts/oneclick/EBPF_XRAY_REPORT.md](../scripts/oneclick/EBPF_XRAY_REPORT.md) |
| W4 XDP gate | [../scripts/oneclick/W4_XDP_GATE_REPORT.md](../scripts/oneclick/W4_XDP_GATE_REPORT.md) |
| Gates 8/8 | [../scripts/oneclick/GATES_8_8_REPORT.md](../scripts/oneclick/GATES_8_8_REPORT.md) |

## Headline verdicts

| Competitor | Axis they own | Elite verdict |
|------------|---------------|---------------|
| Tetragon | Realtime attack block | **DECLINE** (not our product) |
| DeepFlow | App distributed tracing | **DECLINE** APM; **WIN** physics-speed |
| Pixie | K8s debug / flame graphs | **WIN** memory/CPU/VPS; DECLINE PxL |
