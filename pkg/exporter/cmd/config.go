...
type ForecastConfig struct {
	...
	LLCURL          string                 `yaml:"llcURL" mapstructure:"llcURL" json:"llcURL"`
	ReadPSI         bool                   `yaml:"readPSI" mapstructure:"readPSI" json:"readPSI"`
	DecisionPath    string                 `yaml:"decisionPath" mapstructure:"decisionPath" json:"decisionPath"`
