...
## Status: verified on VPS (2026-08-31)
...
Report: [docs/GLOBAL_EBPF_VERIFICATION_REPORT.md](../../docs/GLOBAL_EBPF_VERIFICATION_REPORT.md) · Evidence: [EVIDENCE_REPORT.md](EVIDENCE_REPORT.md)
